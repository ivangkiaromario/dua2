...
<html lang="<?php echo $lang; ?>">
    <head>
        ...
        <title>SOFORTIGE DATEI PDF EPUB MOBI - <?php echo strtoupper( $domains ); ?></title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9">
                    ...
                    <div class="content">
                        <div class="header">
<h1>KOSTENLOSE DOWNLOAD-DATEI PDF EPUB MOBI</h1>
<span style=color:#666;font-size:small><div itemscope itemtype=http://data-vocabulary.org/Review-aggregate><span itemprop=itemreviewed><?php echo $domains; ?></span> <img itemprop=photo src="/favicon.ico"> <span itemprop=rating itemscope itemtype=http://data-vocabulary.org/Rating><span itemprop=average>9</span> out of <span itemprop=best>10</span></span> based on <span itemprop=votes><?php echo number_format(rand( 100, 1000)); ?></span> ratings. <span itemprop=count><?php echo number_format(rand( 1000, 5000)); ?></span> user reviews.</div></span>                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <b>Buchbeschreibungen:</b>
                <p><?php echo $judul; ?> ist eine gute Wahl für Sie, die auf der Suche nach schönen Leseerlebnis. Wir wünschen Ihnen viel Spaß beim Besuch unserer Website.</p>
...
<div class="download">
                                    <h3>Sofortdownload <small>Ihre Datei ist bereit, jetzt herunterladen</small></h3>
                                  <!--  <div class="btn-group btn-group-justified" role="group">
                                    ...
                                    <div class="btn-group btn-group-justified" role="group">
                                        <a class="btn btn-lg btn-primary" rel="nofollow" href="/read.php?id=<?php echo $asin;?>&file=<?php echo $judul; ?>"target="_blank"><i class="glyphicon glyphicon-book" aria-hidden="true"></i> Jetzt downloaden &#10148;</a>
                                    </div>
                                </div>
<center><b><font color="blue"><i class="fa fa-check"></i></font> Mehrsprachige Unterstützung</b><br>Wähle eine Sprache</center>
...
<h3>Willkommen in der besten Bücher-Bibliothek:</h3><br>
<font color="green"><i class="fa fa-check"></i></font> Alle deine Lieblingsbücher und Autoren an einem Ort!<br> 
<font color="green"><i class="fa fa-check"></i></font> Mehr als 10 Millionen Titel für jedes Genre in unserem Buchverzeichnis.<br>
<font color="green"><i class="fa fa-check"></i></font> Njeden Tag neue Titel hinzugefügt! Wir möchten die Dinge frisch halten.<br>
<font color="green"><i class="fa fa-check"></i></font> Kostenlose Anmeldung! um auf PDF-Dateien, E-Books, ePubs, eMagazines und mehr zuzugreifen.<br><br>
<center><img class="img-responsive" src="/award.png"></center>	
<b>Wie es funktioniert?:</b>
								<ul>
									<li>1. Wählen Sie den bereits bereitgestellten Download-Link.</li>
									<li>2. Erstelle einen kostenlosen Account.</li>
									<li>3. Laden Sie so viele Bücher herunter, wie Sie möchten.</li>
									<li>4. Viel Spaß beim Lesen.</li>
								</ul>   
<center><ins class="adsbygoogle"
     style="display:inline-block;width:336px;height:280px"
     data-ad-client="ca-pub-2512705912299368"
...
<!-- <strong>Völlig 100% Free Joint heute!</strong>, Erstellen Sie ein kostenloses Konto und greifen Sie KOSTENLOS auf Ihre Bibliothek zu! Hier können Sie lesen und herunterladen unbegrenzte Bücher Dateiformat Pdf Epub Mobi Kindle Doc Txt. Sie können jederzeit und überall lesen und herunterladen. Holen Sie sich die besten Bücher, Zeitschriften und Comics in jedem Genre, Action, Abenteuer, Manga, Klassiker, Komödie, Referenz, Handbücher, Drama, Ausländischen, Horror, Musik, Romantik, Science-Fiction, Fantasy, Sport und mehr.
								
                <br>

<center><h3>JETZT KOSTENLOSES KONTO ERHALTEN!</h3><br><a href="/signup.php"rel="nofollow"/><img class="img-responsive" src="https://3.bp.blogspot.com/-HNR1dB30PQ8/WrO1E__8W2I/AAAAAAAAAcM/hjv9DrRQWS4I6HhMe513lMDTyN1c88V1ACLcBGAs/s1600/jetzt-registrieren.png"></a></center>
                <br> -->
<!-- start comment -->
        <div id="fbFeedbackContent">
          <div class="top"> <strong>17 Kommentare</strong> <a href="/login.php" onClick="JavaScript:alert('Sie müssen sich vor dem Kommentieren anmelden')">Einen Kommentar hinzufügen</a> </div>
          <ul>
            <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/korryn-mcminn.jpg" alt=""></a>
              <div class="postContainer"> <a href="/login.php">Korryn McMinn</a><span></span>
                ...
                <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('Sie müssen sich vor dem Kommentieren anmelden')">Like</a> · <a class="like"><i></i> 1</a> · <a href="/login.php" onClick="JavaScript:alert('Sie müssen sich vor dem Kommentieren anmelden')">Reply</a> · 1 hr</div>
              </div>
            </li>
            <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/tara-leigh.jpg" alt=""></a>
              <div class="postContainer"> <a href="/login.php">Tara Leigh</a> <span></span>
                ...
                <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('Sie müssen sich vor dem Kommentieren anmelden')">Like</a> · <a class="like"><i></i> 12</a> · <a href="/login.php" onClick="JavaScript:alert('Sie müssen sich vor dem Kommentieren anmelden')">Reply</a> · 1 hr</div>
              </div>
            </li>
            <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/kate-desjardins.jpg" alt=""></a>
              <div class="postContainer"> <a href="/login.php">Kate Desjardins</a>
                ...
                <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('Sie müssen sich vor dem Kommentieren anmelden')">Like</a> · <a class="like"><i></i> 2</a> · <a href="/login.php" onClick="JavaScript:alert('Sie müssen sich vor dem Kommentieren anmelden')">Reply</a> · 1 hr</div>
              </div>
              <ul>
                <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/lauren-armstrong.jpg" alt=""></a>
                  <div class="postContainer"> <a href="/login.php">Lauren Armstrong</a>
                    ...
                    <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('Sie müssen sich vor dem Kommentieren anmelden')">Like</a> · <a class="like"><i></i> 2</a> · <a href="/login.php" onClick="JavaScript:alert('Sie müssen sich vor dem Kommentieren anmelden')">Reply</a> · 48 min</div>
                  </div>
                </li>
              </ul>
            </li>
            <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/kirsty-watson.jpg" alt=""></a>
              <div class="postContainer"> <a href="/login.php">Kirsty Watson</a> <span></span>
                ...
                <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('Sie müssen sich vor dem Kommentieren anmelden')">Like</a> · <a class="like"><i></i> 2</a> · <a href="/login.php" onClick="JavaScript:alert('Sie müssen sich vor dem Kommentieren anmelden')">Reply</a> · 3 hrs</div>
              </div>
            </li>
            ...
            <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/natascha-durham-bivens.jpg" alt=""> </a>
              <div class="postContainer"> <a href="/login.php">Natascha Durham Bivens</a> <span></span>
                ...
                <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('Sie müssen sich vor dem Kommentieren anmelden')">Like</a> · <a class="like"><i></i> 2</a> · <a href="/login.php" onClick="JavaScript:alert('Sie müssen sich vor dem Kommentieren anmelden')">Reply</a> · 5 hrs</div>
              </div>
            </li>
            <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/lynda-dearing.jpg" alt=""></a>
              <div class="postContainer"> <a href="/login.php">Lynda Dearing</a> <span></span>
                ...
                <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('Sie müssen sich vor dem Kommentieren anmelden')">Like</a> · <a class="like"><i></i> 1</a> · <a href="/login.php" onClick="JavaScript:alert('Sie müssen sich vor dem Kommentieren anmelden')">Reply</a> · 8 hrs</div>
              </div>
              <ul>
                <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/brian-laffitte.jpg" alt=""></a>
                  <div class="postContainer"> <a href="/login.php">Brian Laffitte</a>
                    ...
                    <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('Sie müssen sich vor dem Kommentieren anmelden')">Like</a> · <a class="like"><i></i> 17</a> · <a href="/login.php" onClick="JavaScript:alert('Sie müssen sich vor dem Kommentieren anmelden')">Reply</a> · 8 hrs</div>
                  </div>
                  <br />
                  ...
                  <div class="postContainer"> <a href="/login.php">Erin Victoria Zimmerman</a>
                    ...
                    <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('Sie müssen sich vor dem Kommentieren anmelden')">Like</a> · <a class="like"><i></i> 13</a> · <a href="/login.php" onClick="JavaScript:alert('Sie müssen sich vor dem Kommentieren anmelden')">Reply</a> · 8 hrs</div>
                  </div>
                </li>
              </ul>
            </li>
...
<form class="form-wrapper-01" method="get" action="/search"target="_blank" role="search">
    <div id="search">
       <input class="search-input" type="search" name="file" placeholder="Suche hier buchen..">    </div>
    <input id="submit" type="submit" value="Search" />
</form>
                    <ul class="list-group">

                        <li class="list-group-item list-group-item-success">Verwandtes Buch</li>
                            <?php poplist();?>
                    </ul>
                </div>
            </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="padding:1px 50px;">
          ...
          <h4><span class="glyphicon glyphicon-lock"></span> Login für Mitglieder</h4>
...
<center><img class="img-responsive" src="https://3.bp.blogspot.com/-yvwO53J8dr0/WrGxHTAGFaI/AAAAAAAAAbU/tMiDiv47zdYcMfYdRI-aZSE11TqxHX7vgCPcBGAYYCw/s400/ebooklibrary.png" width="500" />
 <div class="alert alert-info"> <p>"Verbinden Sie das Netzwerk der zufriedenen Mitglieder und versuchen Sie diesen Service für <b>Kostenlos</b>. Füllen Sie das Anmeldeformular aus und <b> starten Sie das Buch sofort zu lesen </b>"</p></div>
   <h3>Bitte loggen Sie sich in den Mitgliederbereich ein<br>oder erstellen Sie ein kostenloses Konto, um fortzufahren! </h3>
</center>

 
                       <a href="/login.php"><button type="submit" class="btn btn-success btn-block"><span class="glyphicon glyphicon-off"></span> Login für Mitglieder</button></a>
 <p>Kein Mitglied? <a href="/signup.php">Melde dich kostenlos an</a></p>
        </div>
        <div class="modal-footer">
          <button type="submit" class="btn btn-danger btn-default pull-left" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Stornieren</button>
         
          <p>Vergessen <a href="/forgot.php">Passwort?</a></p>
        </div>
      </div>
