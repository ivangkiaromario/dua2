        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9">
                    ...
                    <div class="content">
                        <div class="header">
<h1>GRATIS DOWNLOAD FILE PDF EPUB MOBI</h1>
<span style=color:#666;font-size:small><div itemscope itemtype=http://data-vocabulary.org/Review-aggregate><span itemprop=itemreviewed><?php echo $domains; ?></span> <img itemprop=photo src="/favicon.ico"> <span itemprop=rating itemscope itemtype=http://data-vocabulary.org/Rating><span itemprop=average>9</span> out of <span itemprop=best>10</span></span> based on <span itemprop=votes><?php echo number_format(rand( 100, 1000)); ?></span> ratings. <span itemprop=count><?php echo number_format(rand( 1000, 5000)); ?></span> user reviews.</div></span>                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <b>Boek beschrijvingen:</b>
                <p><?php echo $judul; ?> is een goede keuze voor jou die op zoek is naar leuke leeservaring. We hopen dat u Veel plezier beleeft om onze website te bezoeken.</p>
...
<div class="download">
                                    <h3>Directe download <small>Uw bestand is klaar, download nu</small></h3>
                                    ...
                                    <div class="btn-group btn-group-justified" role="group">
                                        <a class="btn btn-lg btn-primary" rel="nofollow" href="/read.php?id=<?php echo $asin;?>&file=<?php echo $judul; ?>"target="_blank"><i class="glyphicon glyphicon-book" aria-hidden="true"></i> Download nu &#10148;</a>
                                    </div>
                                </div>
<center><b><font color="blue"><i class="fa fa-check"></i></font> Ondersteuning voor meerdere talen</b><br>Selecteer een taal</center>
...
<center><b><font color="blue"><i class="fa fa-check"></i></font> Multi-formaat beschikbaar</b></center>
...
<h3>Welkom bij de bibliotheek met beste boeken:</h3><br>
<font color="green"><i class="fa fa-check"></i></font> Al je favoriete boeken en auteurs op één plek!<br> 
<font color="green"><i class="fa fa-check"></i></font> Meer dan 10 miljoen titels verspreid over elk genre in onze boekengids.<br>
<font color="green"><i class="fa fa-check"></i></font> Elke dag nieuwe titels toegevoegd! We houden dingen graag fris.<br>
<font color="green"><i class="fa fa-check"></i></font> Gratis registratie! voor toegang tot PDF-bestanden, e-books, ePubs, eMagazines en meer.<br><br>
<center><img class="img-responsive" src="/award.png"></center>	
<b>How it work?:</b>
								<ul>
									<li>1. Kies de Downloadlink die al is meegeleverd.</li>
									<li>2. Maak een gratis account.</li>
									<li>3. Download zoveel boeken als je wilt.</li>
									<li>4. Veel plezier met lezen.</li>
								</ul>   
<center><ins class="adsbygoogle"
     style="display:inline-block;width:336px;height:280px"
     data-ad-client="ca-pub-2512705912299368"
...
<!-- <strong>Totaal 100% gratis joint vandaag!</strong>, Maak een gratis account en krijg GRATIS toegang tot uw bibliotheek! Hier kun je onbeperkt boekenbestand downloaden en downloaden. PDF Epub Mobi Kindle Doc Txt. je kunt altijd en overal lezen en downloaden. Verkrijg de beste boeken, tijdschriften en strips in elk genre, actie, avontuur, manga, klassiekers, komedie, naslagwerken, handleidingen, drama, buitenlands, horror, muziek, romantiek, sciencefiction, fantasy, sport en meer.
								
                <br>

<center><h3>KRIJG NU GRATIS ACCOUNT!</h3><br><a href="/signup.php"rel="nofollow"/><img class="img-responsive" src="https://2.bp.blogspot.com/-uvmE1An2Quk/WrPhhMbx2JI/AAAAAAAAAd8/TKQhwzWI9p0rS-2gOuDfPsD_-yFXLE0QwCLcBGAs/s1600/aanmeld.png"></a></center>
                <br> -->
<!-- start comment -->
        <div id="fbFeedbackContent">
          <div class="top"> <strong>17 Opmerkingen</strong> <a href="/login.php" onClick="JavaScript:alert('Je moet inloggen voordat je reageert')">Voeg een reactie toe</a> </div>
          <ul>
            <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/korryn-mcminn.jpg" alt=""></a>
              <div class="postContainer"> <a href="/login.php">Korryn McMinn</a><span></span>
                ...
                <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('Je moet inloggen voordat je reageert')">Like</a> · <a class="like"><i></i> 1</a> · <a href="/login.php" onClick="JavaScript:alert('Je moet inloggen voordat je reageert')">Reply</a> · 1 hr</div>
              </div>
            </li>
            <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/tara-leigh.jpg" alt=""></a>
              <div class="postContainer"> <a href="/login.php">Tara Leigh</a> <span></span>
                ...
                <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('Je moet inloggen voordat je reageert')">Like</a> · <a class="like"><i></i> 12</a> · <a href="/login.php" onClick="JavaScript:alert('Je moet inloggen voordat je reageert')">Reply</a> · 1 hr</div>
              </div>
            </li>
            <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/kate-desjardins.jpg" alt=""></a>
              <div class="postContainer"> <a href="/login.php">Kate Desjardins</a>
                ...
                <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('Je moet inloggen voordat je reageert')">Like</a> · <a class="like"><i></i> 2</a> · <a href="/login.php" onClick="JavaScript:alert('Je moet inloggen voordat je reageert')">Reply</a> · 1 hr</div>
              </div>
              <ul>
                <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/lauren-armstrong.jpg" alt=""></a>
                  <div class="postContainer"> <a href="/login.php">Lauren Armstrong</a>
                    ...
                    <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('Je moet inloggen voordat je reageert')">Like</a> · <a class="like"><i></i> 2</a> · <a href="/login.php" onClick="JavaScript:alert('Je moet inloggen voordat je reageert')">Reply</a> · 48 min</div>
                  </div>
                </li>
              </ul>
            </li>
            <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/kirsty-watson.jpg" alt=""></a>
              <div class="postContainer"> <a href="/login.php">Kirsty Watson</a> <span></span>
                ...
                <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('Je moet inloggen voordat je reageert')">Like</a> · <a class="like"><i></i> 2</a> · <a href="/login.php" onClick="JavaScript:alert('Je moet inloggen voordat je reageert')">Reply</a> · 3 hrs</div>
              </div>
            </li>
            ...
            <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/natascha-durham-bivens.jpg" alt=""> </a>
              <div class="postContainer"> <a href="/login.php">Natascha Durham Bivens</a> <span></span>
                ...
                <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('Je moet inloggen voordat je reageert')">Like</a> · <a class="like"><i></i> 2</a> · <a href="/login.php" onClick="JavaScript:alert('Je moet inloggen voordat je reageert')">Reply</a> · 5 hrs</div>
              </div>
            </li>
            <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/lynda-dearing.jpg" alt=""></a>
              <div class="postContainer"> <a href="/login.php">Lynda Dearing</a> <span></span>
                ...
                <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('Je moet inloggen voordat je reageert')">Like</a> · <a class="like"><i></i> 1</a> · <a href="/login.php" onClick="JavaScript:alert('Je moet inloggen voordat je reageert')">Reply</a> · 8 hrs</div>
              </div>
              <ul>
                <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/brian-laffitte.jpg" alt=""></a>
                  <div class="postContainer"> <a href="/login.php">Brian Laffitte</a>
                    ...
                    <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('Je moet inloggen voordat je reageert')">Like</a> · <a class="like"><i></i> 17</a> · <a href="/login.php" onClick="JavaScript:alert('Je moet inloggen voordat je reageert')">Reply</a> · 8 hrs</div>
                  </div>
                  <br />
                  ...
                  <div class="postContainer"> <a href="/login.php">Erin Victoria Zimmerman</a>
                    ...
                    <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('Je moet inloggen voordat je reageert')">Like</a> · <a class="like"><i></i> 13</a> · <a href="/login.php" onClick="JavaScript:alert('Je moet inloggen voordat je reageert')">Reply</a> · 8 hrs</div>
                  </div>
                </li>
              </ul>
            </li>
...
<form class="form-wrapper-01" method="get" action="/search"target="_blank" role="search">
    <div id="search">
       <input class="search-input" type="search" name="file" placeholder="Zoek hier een boek..">    </div>
    <input id="submit" type="submit" value="Search" />
</form>
                    <ul class="list-group">

                        <li class="list-group-item list-group-item-success">Gerelateerd boek</li>
                            <?php poplist();?>
                    </ul>
                </div>
            </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="padding:1px 50px;">
          ...
          <h4><span class="glyphicon glyphicon-lock"></span> Inloggen voor Leden</h4>
...
<center><img class="img-responsive" src="https://3.bp.blogspot.com/-yvwO53J8dr0/WrGxHTAGFaI/AAAAAAAAAbU/tMiDiv47zdYcMfYdRI-aZSE11TqxHX7vgCPcBGAYYCw/s400/ebooklibrary.png" width="500" />
 <div class="alert alert-info"> <p>"Verbind het netwerk van tevreden leden en probeer deze service voor <b> Gratis </b>. Vul het aanmeldingsformulier in en <b>begin meteen met het lezen van het boek</b>"</p></div>
   <h3>Meld u aan in het ledengedeelte<br>of maak een gratis account aan om door te gaan! </h3>
</center>

 
                       <a href="/login.php"><button type="submit" class="btn btn-success btn-block"><span class="glyphicon glyphicon-off"></span> Inloggen voor Leden</button></a>
 <p>Geen lid? <a href="/signup.php">Schrijf je gratis in</a></p>
        </div>
        <div class="modal-footer">
          <button type="submit" class="btn btn-danger btn-default pull-left" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Annuleer</button>
         
          <p>Vergeten <a href="/forgot.php">Wachtwoord?</a></p>
        </div>
      </div>
