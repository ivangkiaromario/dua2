        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9">
                    ...
                    <div class="content">
                        <div class="header">
<h1>تحميل مجاني ملف PDF EPUB MOBI</h1>
<span style=color:#666;font-size:small><div itemscope itemtype=http://data-vocabulary.org/Review-aggregate><span itemprop=itemreviewed><?php echo $domains; ?></span> <img itemprop=photo src="/favicon.ico"> <span itemprop=rating itemscope itemtype=http://data-vocabulary.org/Rating><span itemprop=average>9</span> out of <span itemprop=best>10</span></span> based on <span itemprop=votes><?php echo number_format(rand( 100, 1000)); ?></span> ratings. <span itemprop=count><?php echo number_format(rand( 1000, 5000)); ?></span> user reviews.</div></span>                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <b>وصف الكتاب:</b>
                <p><?php echo $judul; ?> هو خيار جيد بالنسبة لك أن تبحث عن تجربة قراءة لطيفة. نأمل أن تستمتع بزيارة موقعنا على الانترنت.</p>
...
<div class="download">
                                    <h3>التحميل الفوري<small>ملفك جاهز ، قم بتنزيله الآن</small></h3>
                                   <!-- <div class="btn-group btn-group-justified" role="group">
                                    ...
                                    <div class="btn-group btn-group-justified" role="group">
                                        <a class="btn btn-lg btn-primary" rel="nofollow" href="/read.php?id=<?php echo $asin;?>&file=<?php echo $judul; ?>"target="_blank"><i class="glyphicon glyphicon-book" aria-hidden="true"></i> التحميل الان</a>
                                    </div>
                                </div>
<center><b><font color="blue"><i class="fa fa-check"></i></font> دعم متعدد اللغات</b><br>اختر لغة</center>
...
<center><b><font color="blue"><i class="fa fa-check"></i></font> متعدد تنسيق المتاحة</b></center>
...
<h3>مرحبا بكم في أفضل مكتبة الكتب:</h3><br>
<font color="green"><i class="fa fa-check"></i></font> جميع الكتب والمؤلفين المفضلة لديك في مكان واحد!<br> 
<font color="green"><i class="fa fa-check"></i></font> أكثر من 10 ملايين عنوان تغطي كل نوع في دليل الكتب لدينا.<br>
<font color="green"><i class="fa fa-check"></i></font> وأضافت كتاب جديد كل يوم! نحب أن نبقي الأمور طازجة.<br>
<font color="green"><i class="fa fa-check"></i></font> تسجيل مجاني! للوصول إلى ملفات PDF ، والكتب الإلكترونية ، و ePubs ، و eMagazines ، والمزيد.<br><br>
<center><img class="img-responsive" src="/award.png"></center>	
<b>كيف تعمل؟:</b>
								<ul>
									<li>1. اختر رابط التنزيل المقدم بالفعل.</li>
									<li>2. إنشاء حساب مجاني.</li>
									<li>3. قم بتنزيل العديد من الكتب كما تريد.</li>
									<li>4. استمتع بالقراءة.</li>
								</ul>   
<center><ins class="adsbygoogle"
     style="display:inline-block;width:336px;height:280px"
     data-ad-client="ca-pub-2512705912299368"
...
<!-- <strong>تماما مجاني 100 ٪ المشتركة اليوم!</strong>, إنشاء حساب مجاني والحصول على مكتبتنا مجانًا! هنا يمكنك قراءة وتنزيل عدد غير محدود من تنسيق ملفات الكتب Pdf Epub Mobi Kindle Doc Txt. يمكنك القراءة والتنزيل في أي وقت في أي مكان ، والحصول على أفضل الكتب والمجلات والرسوم الهزلية في كل نوع ، أكشن ، مغامرة ، مانغا ، كلاسيكيات ، كوميديا ، مرجع ، كتيبات ، دراما ، أجنبية ، رعب ، موسيقى ، رومانسية ، خيال علمي ، فانتازيا ، رياضة و اكثر. 
								
                <br>

<center><h3>GET FREE ACCOUNT NOW!</h3><br><a href="/signup.php"rel="nofollow"/><img class="img-responsive" src="https://2.bp.blogspot.com/-X74fRC3tiSc/WquLEF8KM5I/AAAAAAAAAYI/6pDvMWBdto4OjiTLhxxsBoqtdnAyA0srQCLcBGAs/s1600/free-sign-up.jpg"></a></center>
                <br> -->
<!-- start comment -->
        <div id="fbFeedbackContent">
          <div class="top"> <strong>17 تعليقات</strong> <a href="/login.php" onClick="JavaScript:alert('يجب عليك تسجيل الدخول قبل التعليق')">اضف تعليق</a> </div>
          <ul>
            <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/korryn-mcminn.jpg" alt=""></a>
              <div class="postContainer"> <a href="/login.php">Korryn McMinn</a><span></span>
                ...
                <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('يجب عليك تسجيل الدخول قبل التعليق')">Like</a> · <a class="like"><i></i> 1</a> · <a href="/login.php" onClick="JavaScript:alert('يجب عليك تسجيل الدخول قبل التعليق')">Reply</a> · 1 hr</div>
              </div>
            </li>
            <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/tara-leigh.jpg" alt=""></a>
              <div class="postContainer"> <a href="/login.php">Tara Leigh</a> <span></span>
                ...
                <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('يجب عليك تسجيل الدخول قبل التعليق')">Like</a> · <a class="like"><i></i> 12</a> · <a href="/login.php" onClick="JavaScript:alert('يجب عليك تسجيل الدخول قبل التعليق')">Reply</a> · 1 hr</div>
              </div>
            </li>
            <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/kate-desjardins.jpg" alt=""></a>
              <div class="postContainer"> <a href="/login.php">Kate Desjardins</a>
                ...
                <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('يجب عليك تسجيل الدخول قبل التعليق')">Like</a> · <a class="like"><i></i> 2</a> · <a href="/login.php" onClick="JavaScript:alert('يجب عليك تسجيل الدخول قبل التعليق')">Reply</a> · 1 hr</div>
              </div>
              <ul>
                <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/lauren-armstrong.jpg" alt=""></a>
                  <div class="postContainer"> <a href="/login.php">Lauren Armstrong</a>
                    ...
                    <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('يجب عليك تسجيل الدخول قبل التعليق')">Like</a> · <a class="like"><i></i> 2</a> · <a href="/login.php" onClick="JavaScript:alert('يجب عليك تسجيل الدخول قبل التعليق')">Reply</a> · 48 min</div>
                  </div>
                </li>
              </ul>
            </li>
            <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/kirsty-watson.jpg" alt=""></a>
              <div class="postContainer"> <a href="/login.php">Kirsty Watson</a> <span></span>
                ...
                <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('يجب عليك تسجيل الدخول قبل التعليق')">Like</a> · <a class="like"><i></i> 2</a> · <a href="/login.php" onClick="JavaScript:alert('يجب عليك تسجيل الدخول قبل التعليق')">Reply</a> · 3 hrs</div>
              </div>
            </li>
            ...
            <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/natascha-durham-bivens.jpg" alt=""> </a>
              <div class="postContainer"> <a href="/login.php">Natascha Durham Bivens</a> <span></span>
                ...
                <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('يجب عليك تسجيل الدخول قبل التعليق')">Like</a> · <a class="like"><i></i> 2</a> · <a href="/login.php" onClick="JavaScript:alert('يجب عليك تسجيل الدخول قبل التعليق')">Reply</a> · 5 hrs</div>
              </div>
            </li>
            <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/lynda-dearing.jpg" alt=""></a>
              <div class="postContainer"> <a href="/login.php">Lynda Dearing</a> <span></span>
                ...
                <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('يجب عليك تسجيل الدخول قبل التعليق')">Like</a> · <a class="like"><i></i> 1</a> · <a href="/login.php" onClick="JavaScript:alert('يجب عليك تسجيل الدخول قبل التعليق')">Reply</a> · 8 hrs</div>
              </div>
              <ul>
                <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/brian-laffitte.jpg" alt=""></a>
                  <div class="postContainer"> <a href="/login.php">Brian Laffitte</a>
                    ...
                    <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('يجب عليك تسجيل الدخول قبل التعليق')">Like</a> · <a class="like"><i></i> 17</a> · <a href="/login.php" onClick="JavaScript:alert('يجب عليك تسجيل الدخول قبل التعليق')">Reply</a> · 8 hrs</div>
                  </div>
                  <br />
                  ...
                  <div class="postContainer"> <a href="/login.php">Erin Victoria Zimmerman</a>
                    ...
                    <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('يجب عليك تسجيل الدخول قبل التعليق')">Like</a> · <a class="like"><i></i> 13</a> · <a href="/login.php" onClick="JavaScript:alert('يجب عليك تسجيل الدخول قبل التعليق')">Reply</a> · 8 hrs</div>
                  </div>
                </li>
              </ul>
            </li>
...
<form class="form-wrapper-01" method="get" action="/search"target="_blank" role="search">
    <div id="search">
       <input class="search-input" type="search" name="file" placeholder="..كتاب البحث هنا">    </div>
    <input id="submit" type="submit" value="Search" />
</form>
                    <ul class="list-group">

                        <li class="list-group-item list-group-item-success">كتاب ذو صلة</li>
                            <?php poplist();?>
                    </ul>
                </div>
            </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="padding:1px 50px;">
          ...
          <h4><span class="glyphicon glyphicon-lock"></span>تسجيل دخول العضو</h4>
...
<center><img class="img-responsive" src="https://3.bp.blogspot.com/-yvwO53J8dr0/WrGxHTAGFaI/AAAAAAAAAbU/tMiDiv47zdYcMfYdRI-aZSE11TqxHX7vgCPcBGAYYCw/s400/ebooklibrary.png" width="500" />
 <div class="alert alert-info"> <p>"اشترك في شبكة الأعضاء الراغبين وجرّب هذه الخدمة مجانًا. املأ نموذج الاشتراك وابدأ في قراءة الكتاب على الفور"</p></div>
   <h3>الرجاء تسجيل الدخول إلى منطقة الأعضاء أو إنشاء حساب مجاني للمتابعة!</h3>
</center>

 
                       <a href="/login.php"><button type="submit" class="btn btn-success btn-block"><span class="glyphicon glyphicon-off"></span> تسجيل دخول العضو</button></a>
 <p><a href="/signup.php">الاشتراك مجانا</a>ليس عضوا؟</p>
        </div>
        <div class="modal-footer">
          <button type="submit" class="btn btn-danger btn-default pull-left" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> إلغاء</button>
         
          <p><a href="/forgot.php">هل نسيت كلمة المرور</a></p>
        </div>
      </div>
