...
<title><?php echo $judul;?> PDF File</title>
...
<img alt="<?php echo $title;?>" id="coverImage" src="http://<?php echo $gambar;?>" onerror="this.src='/page/page<?php echo number_format(rand( 1, 11)); ?>.jpg'"class="img-responsive" style="margin-bottom: 40px;padding-top:30px; display: inherit; width: 100%;"></a>
...
_Hasync.push(['Histats.start', '1,4023743,4,0,0,0,00010000']);
...
<noscript><a href="/" target="_blank"><img  src="//sstatic1.histats.com/0.gif?4023743&101" alt="" border="0"></a></noscript>
<!-- Histats.com  END  -->
</body>
</html> 
