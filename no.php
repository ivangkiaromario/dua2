...
<html lang="<?php echo $lang; ?>">
    <head>
        ...
        <title>INSTANT FIL PDF EPUB MOBI - <?php echo strtoupper( $domains ); ?></title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9">
                    ...
                    <div class="content">
                        <div class="header">
<h1>GRATIS DOWNLOAD FIL PDF EPUB MOBI</h1>
<span style=color:#666;font-size:small><div itemscope itemtype=http://data-vocabulary.org/Review-aggregate><span itemprop=itemreviewed><?php echo $domains; ?></span> <img itemprop=photo src="/favicon.ico"> <span itemprop=rating itemscope itemtype=http://data-vocabulary.org/Rating><span itemprop=average>9</span> out of <span itemprop=best>10</span></span> based on <span itemprop=votes><?php echo number_format(rand( 100, 1000)); ?></span> ratings. <span itemprop=count><?php echo number_format(rand( 1000, 5000)); ?></span> user reviews.</div></span>                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <b>Bokbeskrivelser:</b>
                <p><?php echo $judul; ?> er godt valg for deg som ser etter fin leseopplevelse. Vi håper du liker å besøke vår nettside.</p>
...
<div class="download">
                                    <h3>Øyeblikkelig nedlasting <small>Filen din er klar, last ned nå</small></h3>
                                    ...
                                    <div class="btn-group btn-group-justified" role="group">
                                        <a class="btn btn-lg btn-primary" rel="nofollow" href="/read.php?id=<?php echo $asin;?>&file=<?php echo $judul; ?>"target="_blank"><i class="glyphicon glyphicon-book" aria-hidden="true"></i> LAST NED NÅ &#10148;</a>
                                    </div>
                                </div>
<center><b><font color="blue"><i class="fa fa-check"></i></font> Multispråk Støtte</b><br>Velg et språk</center>
...
<center><b><font color="blue"><i class="fa fa-check"></i></font> Multi-format tilgjengelig</b></center>
...
<h3>Velkommen til Best Books Library:</h3><br>
<font color="green"><i class="fa fa-check"></i></font> Alle dine favorittbøker og forfattere på ett sted!<br> 
<font color="green"><i class="fa fa-check"></i></font> Mer enn 10 millioner titler spenner over hver sjanger i vår bokkatalog.<br>
<font color="green"><i class="fa fa-check"></i></font> Nye titler legges til hver dag! Vi liker å holde ting friskt.<br>
<font color="green"><i class="fa fa-check"></i></font> Gratis registrering! å få tilgang til PDF-filer, e-bøker, ePubs, eMagazines og mer.<br><br>
<center><img class="img-responsive" src="/award.png"></center>	
<b>Hvordan det virker?:</b>
								<ul>
									<li>1. Velg nedlastingslinken som allerede er oppgitt.</li>
									<li>2. Opprett en gratis konto.</li>
									<li>3. Last ned så mange bøker som du vil.</li>
									<li>4. Liker å lese.</li>
								</ul>   
<center><ins class="adsbygoogle"
     style="display:inline-block;width:336px;height:280px"
     data-ad-client="ca-pub-2512705912299368"
...
<!-- <strong>Helt 100% gratis felles i dag!</strong>, Opprett gratis konto og få tilgang til biblioteket ditt GRATIS! Her kan du lese og laste ned ubegrenset bøker filformat Pdf Epub Mobi Kindle Doc Txt. Du kan lese og laste ned når som helst hvor som helst. Få de beste bøkene, Magasiner og tegneserier i alle sjangere, Action, Eventyr, Manga, Klassikere, Komedie, Referanse, Håndbøker, Drama, Utenlandske, Horror, Musikk, Romantikk, Science Fiction, Fantasy, Sport og mer. 
								
                <br>

<center><h3>FÅ GRATIS KONTO NÅ!</h3><br><a href="/signup.php"rel="nofollow"/><img class="img-responsive" src="https://2.bp.blogspot.com/-X74fRC3tiSc/WquLEF8KM5I/AAAAAAAAAYI/6pDvMWBdto4OjiTLhxxsBoqtdnAyA0srQCLcBGAs/s1600/free-sign-up.jpg"></a></center>
                <br> -->
<!-- start comment -->
        <div id="fbFeedbackContent">
          <div class="top"> <strong>17 kommentarer</strong> <a href="/login.php" onClick="JavaScript:alert('Du må logge inn før du kommenterer')">Legg til en kommentar</a> </div>
          <ul>
            <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/korryn-mcminn.jpg" alt=""></a>
              <div class="postContainer"> <a href="/login.php">Korryn McMinn</a><span></span>
                ...
                <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('Du må logge inn før du kommenterer')">Like</a> · <a class="like"><i></i> 1</a> · <a href="/login.php" onClick="JavaScript:alert('Du må logge inn før du kommenterer')">Reply</a> · 1 hr</div>
              </div>
            </li>
            <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/tara-leigh.jpg" alt=""></a>
              <div class="postContainer"> <a href="/login.php">Tara Leigh</a> <span></span>
                ...
                <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('Du må logge inn før du kommenterer')">Like</a> · <a class="like"><i></i> 12</a> · <a href="/login.php" onClick="JavaScript:alert('Du må logge inn før du kommenterer')">Reply</a> · 1 hr</div>
              </div>
            </li>
            <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/kate-desjardins.jpg" alt=""></a>
              <div class="postContainer"> <a href="/login.php">Kate Desjardins</a>
                ...
                <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('Du må logge inn før du kommenterer')">Like</a> · <a class="like"><i></i> 2</a> · <a href="/login.php" onClick="JavaScript:alert('Du må logge inn før du kommenterer')">Reply</a> · 1 hr</div>
              </div>
              <ul>
                <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/lauren-armstrong.jpg" alt=""></a>
                  <div class="postContainer"> <a href="/login.php">Lauren Armstrong</a>
                    ...
                    <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('Du må logge inn før du kommenterer')">Like</a> · <a class="like"><i></i> 2</a> · <a href="/login.php" onClick="JavaScript:alert('Du må logge inn før du kommenterer')">Reply</a> · 48 min</div>
                  </div>
                </li>
              </ul>
            </li>
            <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/kirsty-watson.jpg" alt=""></a>
              <div class="postContainer"> <a href="/login.php">Kirsty Watson</a> <span></span>
                ...
                <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('Du må logge inn før du kommenterer')">Like</a> · <a class="like"><i></i> 2</a> · <a href="/login.php" onClick="JavaScript:alert('Du må logge inn før du kommenterer')">Reply</a> · 3 hrs</div>
              </div>
            </li>
            ...
            <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/natascha-durham-bivens.jpg" alt=""> </a>
              <div class="postContainer"> <a href="/login.php">Natascha Durham Bivens</a> <span></span>
                ...
                <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('Du må logge inn før du kommenterer')">Like</a> · <a class="like"><i></i> 2</a> · <a href="/login.php" onClick="JavaScript:alert('Du må logge inn før du kommenterer')">Reply</a> · 5 hrs</div>
              </div>
            </li>
            <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/lynda-dearing.jpg" alt=""></a>
              <div class="postContainer"> <a href="/login.php">Lynda Dearing</a> <span></span>
                ...
                <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('Du må logge inn før du kommenterer')">Like</a> · <a class="like"><i></i> 1</a> · <a href="/login.php" onClick="JavaScript:alert('Du må logge inn før du kommenterer')">Reply</a> · 8 hrs</div>
              </div>
              <ul>
                <li> <a class="image"><img class="img" src="http://pdfzon.com/wp-content/themes/asingenerator/lp/dlibs/brian-laffitte.jpg" alt=""></a>
                  <div class="postContainer"> <a href="/login.php">Brian Laffitte</a>
                    ...
                    <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('Du må logge inn før du kommenterer')">Like</a> · <a class="like"><i></i> 17</a> · <a href="/login.php" onClick="JavaScript:alert('Du må logge inn før du kommenterer')">Reply</a> · 8 hrs</div>
                  </div>
                  <br />
                  ...
                  <div class="postContainer"> <a href="/login.php">Erin Victoria Zimmerman</a>
                    ...
                    <div class="bottom"> <a href="/login.php"onClick="JavaScript:alert('Du må logge inn før du kommenterer')">Like</a> · <a class="like"><i></i> 13</a> · <a href="/login.php" onClick="JavaScript:alert('Du må logge inn før du kommenterer')">Reply</a> · 8 hrs</div>
                  </div>
                </li>
              </ul>
            </li>
...
<form class="form-wrapper-01" method="get" action="/search"target="_blank" role="search">
    <div id="search">
       <input class="search-input" type="search" name="file" placeholder="Søk bok her..">    </div>
    <input id="submit" type="submit" value="Search" />
</form>
                    <ul class="list-group">

                        <li class="list-group-item list-group-item-success">Relatert bok</li>
                            <?php poplist();?>
                    </ul>
                </div>
            </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="padding:1px 50px;">
          ...
          <h4><span class="glyphicon glyphicon-lock"></span> Medlems innlogging</h4>
...
<center><img class="img-responsive" src="https://3.bp.blogspot.com/-yvwO53J8dr0/WrGxHTAGFaI/AAAAAAAAAbU/tMiDiv47zdYcMfYdRI-aZSE11TqxHX7vgCPcBGAYYCw/s400/ebooklibrary.png" width="500" />
 <div class="alert alert-info"> <p>"Føy nettverket av fornøyde medlemmer og prøv denne tjenesten <b>Gratis</b>. Fyll ut registreringsskjemaet og <b>begynn å lese boken umiddelbart</b>"</p></div>
   <h3>Vennligst Logg inn på medlemsområdet<br>eller lag gratis konto for å fortsette! </h3>
</center>

 
                       <a href="/login.php"><button type="submit" class="btn btn-success btn-block"><span class="glyphicon glyphicon-off"></span> Medlems innlogging</button></a>
 <p>Ikke et medlem? <a href="/signup.php">Registrer deg gratis</a></p>
        </div>
        <div class="modal-footer">
          <button type="submit" class="btn btn-danger btn-default pull-left" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Avbryt</button>
         
          <p>Glemte <a href="/forgot.php">Passord?</a></p>
        </div>
      </div>
